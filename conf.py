...
project = u'Documentación para el Desarrollador de Mozilla Hispano'
copyright = u'2013, Mozilla Hispano. Basado en el trabajo de Dave Dash, Laura Thompson, Jeff Balogh y Mozilla Webdev Team'
...
htmlhelp_basename = 'DocumentacionDesarrolladorMozillaHispanodoc'
